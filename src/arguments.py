...
class TrainingArguments(TrainingArguments):
    ...
    cms_utility_weight: float = field(default=1.0, metadata={"help": "Weight of the CMS-MRL utility-guided routing loss"})
    cms_cmi_weight: float = field(default=0.1, metadata={"help": "Weight of the CMS-MRL conditional multimodal interaction loss"})
@dataclass
class MTEBArguments:
