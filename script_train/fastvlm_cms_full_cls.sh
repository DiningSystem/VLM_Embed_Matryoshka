...
# CMS-MRL FULL classification run for apple/FastVLM-0.5B.
torchrun --standalone --nproc_per_node=1 --master_port=29500 train_ddp_one_model.py \
    ...
    --output_dir training/CMSMRL_FastVLM_cls_full \
    ...
    --kd_loss_type cms_mrl --warmup_ratio 0.03 --image_resolution 448 \
