...
# CMS-MRL CMI classification run for Qwen/Qwen3-VL-Embedding-2B.
torchrun --standalone --nproc_per_node=1 --master_port=29500 train_ddp_one_model.py \
    ...
    --output_dir training/CMSMRL_Qwen3VL_2B_cls_cmi \
    ...
    --kd_loss_type cms_cmi --warmup_ratio 0.03 --image_resolution mid \
